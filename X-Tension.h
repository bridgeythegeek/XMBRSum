...
// XWF_GetSize (tested)
typedef INT64 (__stdcall *fptr_XWF_GetSize) (HANDLE hVolumeOrItem, BYTE* lpOptional);
...
// XWF_Read (tested)
typedef DWORD (__stdcall *fptr_XWF_Read) (HANDLE hVolumeOrItem, INT64 Offset, BYTE* lpBuffer, 
	DWORD nNumberOfBytesToRead);

// XWF_SelectVolumeSnapshot
typedef void (__stdcall *fptr_XWF_SelectVolumeSnapshot) (HANDLE hVolume);

// XWF_GetItemCount (tested)
...
// XWF_SetItemSize
typedef void (__stdcall *fptr_XWF_SetItemSize) (LONG nItemID, INT64 size); 
...
typedef BOOL (__stdcall *fptr_XWF_SetItemInformation) (LONG nItemID, 
   LONG InfoType, INT64 nInfoValue);
...
// XWF_GetMetadata
typedef LPWSTR (__stdcall * fptr_XWF_GetMetadata) (LONG nItemID, HANDLE hItem);
...
typedef DWORD (__stdcall * fptr_XWF_SectorIO) (LONG nDrive, INT64 nSector, DWORD nCount, LPVOID lpBuffer, LPDWORD nFlags);
...
extern fptr_XWF_GetMetadata XWF_GetMetadata;
...
__declspec(dllexport) LONG __stdcall XT_Init(CallerInfo info, DWORD nFlags, HANDLE hMainWnd, void* lpReserved);
...
// XT_Done
// __declspec(dllexport) LONG __stdcall XT_Done(void* lpReserved);

// XT_About
//LONG __stdcall XT_About(HANDLE hParentWnd, void* lpReserved);

// XT_Prepare
__declspec (dllexport) LONG __stdcall XT_Prepare(HANDLE hVolume, HANDLE hEvidence, DWORD nOpType, void* lpReserved);
